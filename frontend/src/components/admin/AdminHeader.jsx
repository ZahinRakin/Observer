...
const AdminHeader = ({ user, onViewProfile, onEditProfile }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 border-b border-gray-700 px-6 py-4 shadow-lg backdrop-blur-sm">
      ...
      <div className="flex items-center gap-6">
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent tracking-tight">Admin Dashboard</h1>
          </div>
          <span className="text-gray-300 text-sm ml-11 mt-1">Welcome back, {user ? user.username : 'Admin'}</span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6 ml-8">
          ...
          {/* <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-300">24 Active Users</span>
          </div> */}
        </div>
      </div>
            ...
            >
              ...
              <div className="px-4 py-3 border-b border-gray-600 bg-gradient-to-r from-blue-900/50 to-purple-900/50">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <div className="font-medium text-white text-sm">{user?.username || 'Admin'}</div>
